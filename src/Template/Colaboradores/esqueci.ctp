...
<div class="row">
    ...
    <div class="col-md-12" id="mensagem_header_default">
        <p>Utilize seu e-mail/login ou seu celular cadastrado para receber uma nova senha de acesso ao sistema.</p>
    </div>
    <div class="col-md-12">
        <h4>E-mail/Login</h4>
    ...
    <div class="col-md-12">
        <h4>Celular</h4>
        <?php echo $this->Form->input('celular', array('class' => 'form-control', 'id' => 'UsuarioCelular', 'div' => false, 'label' => false, 'placeholder' => 'Celular', 'after' => false, 'before' => false, 'type' => 'text', 'required' => false)); ?>
        <div class="btn-group login" role="group">
			<button class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-phone"></span> Enviar</button>
		</div>
    </div>
