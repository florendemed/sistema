...
<div class="row">
	<div class="col-md-12" id="mensagem_header_default">
		<ul class="breadcrumb">
			<li class="active">Dados / Relatórios / Exames</li>
		</ul>
		<div class="well filtros">
			<form action="/Relatorios/exames" class="form-horizontal" method="get" accept-charset="utf-8">	
				<fieldset>
					<div class="row">
						<div class="col-md-2">
							<?php 
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					foreach ($resultado as $qr): 
						...
						?>
						<tr>
							<td><?= substr($qr->exame->nome, 0, 40) ?></td>
							<td><?= $qr->count ?></td>
						</tr>
						<?php 
					endforeach; 
