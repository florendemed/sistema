				...
				<div class="col-md-6">
					<fieldset>
						<div class="form-group required">
							...
							<div class="col-md-8">
								<input name="data[Permissao][nome]" maxlength="120" class="form-control" type="text" id="PermissaoNome" required="required"/>
							</div>
						</div>	
						<div class="form-group required">
							...
							<div class="col-md-8">
								...
								<input type="checkbox" name="data[Permissao][menu]"  value="1" class="" id="PermissaoMenu"/>
							</div>
						</div>	
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<input type="checkbox" name="data[Permissao][lista]"  value="1" class="" id="PermissaoLista"/>
							</div>
						</div>
						<div class="form-group required">
							<label for="PermissaoOrdem" class="col-md-3 control-label">Ordem</label>
							<div class="col-md-8">
								<input name="data[Permissao][ordem]" class="form-control" type="number" id="PermissaoOrdem" required="required"/>
							</div>
						</div>	
						<div class="form-group required">
				...
				<div class="col-md-6">
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input name="data[Permissao][controller]" maxlength="120" class="form-control" type="text" id="PermissaoController"/>
							</div>
						</div>
						<div class="form-group">
