				...
				<div class="col-md-6">
					...
					<fieldset>
						...
						<div class="form-group required">
							...
							<div class="col-md-5">
								<?php echo $this->Form->input('data_nascimento', ['type' => 'text', 'label' => false, 'class' => 'form-control', 'id' => 'dataNascimento']); ?>
							</div>
						</div>
						<div class="form-group required">
				...
				<div class="col-md-6">
					...
					<fieldset>
						<div class="form-group required">
							...
							<div class="col-md-4">
								<?php echo $this->Form->input('Endereco.cep', ['label' => false, 'class' => 'form-control', 'id' => 'cep']); ?>
							</div>
						</div>	
						<div class="form-group required">
						...
						<div id="novoTelefone">
							...
							<div class="form-group required">
								...
								<div class="col-md-4">
									<?php echo $this->Form->input('Telefone.numero', ['label' => false, 'class' => 'form-control', 'id' => 'telefone']); ?>
								</div>
							</div>
							<div class="form-group required">
